...
# Create RSS element with appropriate attributes and namespaces: --request by apple feed
...
output_tree.write('01_podcast.xml', encoding='UTF-8', xml_declaration=True) # Write the XML tree to a file
